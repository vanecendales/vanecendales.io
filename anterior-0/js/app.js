...
$(document).ready(function() {
	...
	(function(){
		...
		if ( window.location.href.indexOf('about') > -1 ) {
			...
			letter.css('transition-duration', '0s').addClass('is-animate animation-finished');
	
		} else if ( window.location.href.indexOf('about') == -1 && firstSection.length ) {
	...
	function navHover() {
		...
		navLink.mouseenter(function() {
			...
			portfolioImg.attr('href', $(this).find('a').attr('href'));
	...
	function changeColor(){
		if ( whiteSection.length > 0 ) {
			...
			if ( scrollPos >= whiteSection.offset().top - headHeight && scrollPos <= whiteSectionTop + whiteSectionH - headHeight ) {
	...
	function VideoLazyLoad(vid) {
		...
		var obj = {
			...
			_play: function() {
				if ( scrollPos + $(window).height() >= this.video.offset().top && this.videoLoaded === false ) {
